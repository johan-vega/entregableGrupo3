...
@section('content')
    <section class="auth-shell">
        <article class="auth-panel">
            <div>
                <span class="section-kicker">Inicio seguro y humano</span>
                <h1 class="auth-title">Entra al sistema de citas sin friccion y con la informacion justa.</h1>
                <p class="auth-copy">
                    Diseñado para recepcionistas, medicos, administradores y personal de apoyo que necesitan claridad
            ...
            <div class="auth-highlights">
                <div class="auth-highlight">
                    ...
                    <span>Email y password para el flujo clasico del sistema.</span>
                </div>
                <div class="auth-highlight">
                    <strong>Ingreso social</strong>
                    <span>Botones conectados para Google y GitHub cuando coloques tus credenciales.</span>
                </div>
                <div class="auth-highlight">
                    <strong>Contexto claro</strong>
                    <span>Resumen visual para orientar a cualquier perfil de usuario.</span>
                </div>
                <div class="auth-highlight">
                    <strong>Escalable</strong>
                    <span>Listo para tus pruebas en hosting gratuito y siguientes ajustes.</span>
                </div>
            </div>
        </article>
        ...
        <article class="auth-card">
            <div class="auth-card__header">
                ...
                <p>Inicia sesion para continuar con la agenda, los pacientes y el seguimiento clinico.</p>
            </div>
            ...
            <div class="divider">o con tu cuenta del sistema</div>
            ...
            <form class="auth-form" method="POST" action="{{ route('login') }}">
                ...
                <div class="field-group">
                    ...
                    <input id="login" class="input" type="text" name="login" value="{{ old('login') }}" required autocomplete="username" autofocus>
                    @error('login')
                ...
                <div class="checkbox-row">
                    ...
                    @if (Route::has('password.request'))
                        <a class="helper-link" href="{{ route('password.request') }}">Olvide mi contrasena</a>
                    @endif
                </div>

                <button class="button button--block" type="submit">Entrar al panel</button>
            </form>

            <div class="inline-actions">
                <span class="section-copy">¿Aun no tienes acceso?</span>
                <a class="helper-link" href="{{ route('register') }}">Crear una cuenta nueva</a>
            </div>

            <div class="inline-actions">
                <span class="section-copy">Acceso de prueba para administrador:</span>
                <span class="helper-link">usuario: admin | contrasena: admin</span>
            </div>
        </article>
    </section>
@endsection
